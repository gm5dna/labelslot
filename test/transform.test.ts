// Scaffold smoke test. The transform slice replaces this file with real tests.
import { test } from 'node:test';
import assert from 'node:assert/strict';
import * as m from '../src/transform.ts';

test('transform: stubs are not yet implemented', async () => {
