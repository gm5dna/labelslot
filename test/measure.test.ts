// Scaffold smoke test. The measure slice replaces this file with real tests.
import { test } from 'node:test';
import assert from 'node:assert/strict';
import * as m from '../src/measure.ts';

test('measure: stubs are not yet implemented', async () => {
